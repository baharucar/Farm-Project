<cf_get_lang_set module_name="sales">
    ...
    <div class="col col-12 col-md-12 col-sm-12 col-xs-12">
        <cf_box>
            <cfform action="#request.self#?fuseaction=sales.list_suttakip" method="post" name="filter_animals">
        ...
        <cfsavecontent variable="message"><cf_get_lang dictionary_id="65161.Süt Takip"></cfsavecontent>
        <cf_box title="#message#" uidrop="1" hide_table_column="1">
            <cf_flat_list>
                <thead>
                    ...
                    <th>Sağım Süresi</th>
                    <th>Sağım Tarihi</th>
                    <th><a href="<cfoutput>#request.self#?fuseaction=sales.list_suttakip&event=add</cfoutput>"><i class="fa fa-plus" title="<cf_get_lang dictionary_id='57582.ekle'>" alt="<cf_get_lang dictionary_id='57582.ekle'>"></i></a></th>
                </thead>
                <tbody>
                    <cfif isDefined("attributes.is_submit") and len(attributes.is_submit)>
                        <cfoutput query="get_sut">
                            <tr>
                                <td>#currentRow#</td>
                                <td><a href="#request.self#?fuseaction=sales.list_suttakip&event=upd&animal_id=#animalID#">#animalName#</a></td>
                                <td>#sagimSaati#</td>
                                <td>#sutMiktarKG#</td>
                                <td>#sagimSuresiSN#</td>
                                <td>#tarih#</td>
